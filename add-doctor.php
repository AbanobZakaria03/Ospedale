...
$sql=mysqli_query($con,"insert into doctor(name,gender,phone,address,specialization)
                    values('$doctorname','$doctorgender','$doctorphone','$doctoradress','$doctorspecialization')");
...
echo "<script>window.location.href ='doctors.php'</script>";
  ...
  echo "<script>alert('Doctor Creation failed!');</script>";
}
}
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" required name="specialization">
                                    </div>
                                </div>
                            </div>
